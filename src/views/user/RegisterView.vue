...
<template>
  <AuthScreenShell title="建立帳號開始新的安排" description="用最簡單的方式加入 TwoDo，建立你的任務節奏與每日進度。" card-title="註冊 TwoDo"
    ...
    <form class="mt-5 space-y-4" @submit.prevent="handleSignUp">
      ...
      <label class="block space-y-2">
        ...
        <input v-model="password" class="app-input" type="password" autocomplete="new-password"
      ...
      <button class="app-primary-button w-full" type="submit" :disabled="isAuthActionPending || !canCreateAccount">
