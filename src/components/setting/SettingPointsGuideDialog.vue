...
<template>
  ...
  >
    <div class="grid gap-[14px] px-[22px] pb-[22px] pt-[18px] text-left">
      <p class="m-[0px] text-[15px] font-[500] leading-[24px] tracking-[0] text-[var(--app-text)]">
        完成任務後，可以獲得任務設定的點數。
      </p>

      <ul class="grid list-none gap-[12px] m-[0px] p-[0px]">
        <li class="grid gap-[4px] border-l-[3px] border-l-[var(--app-accent)] pl-[14px]">
          <strong class="text-[15px] font-[700] leading-[22px] tracking-[0] text-[var(--app-text-strong)]">
            個人任務
          </strong>
          <span class="text-[14px] leading-[22px] tracking-[0] text-[var(--app-text-muted)]">
